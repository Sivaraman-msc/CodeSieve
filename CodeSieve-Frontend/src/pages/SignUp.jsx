      ...
      <div className="relative z-30 lg:ml-210 w-full max-w-sm bg-white shadow-2xl rounded-xl p-6 mx-4">
        ...
        <form onSubmit={handleSubmit(handleClick)} className="space-y-5">
          ...
          <div className="relative">
            ...
            <button type="button"className="absolute right-3 top-2 text-xs text-gray-600 hover:text-black"onClick={() => setVisible(!visible)}>{visible ? 'Hide' : 'Show'} </button>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <Link to="/" className="text-black font-medium hover:underline">Login</Link>
        </div>
      </div>
    </div>
  );
